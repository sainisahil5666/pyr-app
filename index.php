...
<html lang="en">
	...
	<body class=" body header-logo-center fixed-header footer-block"> 
		<!-- <div id="header" class="container">
			<div class="row justify-content-center" style="padding-top: 20px;">
					<img src="https://starclinchstorage.blob.core.windows.net/home/StarClinch-logo.png" class="">
			</div>
		</div> -->
		<div id="headerwrap">
            <header id="header" class="pagewidth clearfix" itemscope="itemscope" itemtype="https://schema.org/WPHeader">
                ...
                <div class="logo-wrap">
                    <div id="site-logo"><a href="/" title="Back to homepage"><img src="https://starclinch1.wpengine.com/wp-content/uploads/2018/09/StarClinch_logo_200x.png" style="height: 40px;margin-top: 10px; margin-bottom: 10px;"></a></div>
                    <div id="site-description" class="site-description"><span>Back to Homepage</span></div>
                </div>
                    <!-- <div class="top-icon-wrap">
                        <ul class="icon-menu">
                            <li class="wishlist">
                                <a class="tools_button" href="https://stardev.wpengine.com/cart/">
		...
		<div id="get-quote" class="container">
			<section class="content" style="padding-top: 20px;">
				...
				<div class="row">
					<div class="col-md-2 col-sm-2 col-sm-offset-0 col-xs-4 col-xs-offset-4">
						...
						<div class="col-md-10 col-sm-12 col-xs-12">
							<div class="thumbnail">
						        <img id="snippet-artist-thumb" src="http://marketline.com/wp-content/plugins/all-in-one-seo-pack/images/default-user-image.png" alt="" style="width:100%">
						        <div class="caption">
						          <p id="snippet-artist-name" class="text-center"></p>
						          <p id="snippet-artist-category" class="text-center" style="font-size: 12px;"></p>
						        </div>
						    </div>
						</div>
						</div>
				...
				<fieldset id="fields-category">
					<div class="row">
						<div class="col-md-2 col-md-2 col-sm-3 col-xs-6">
						    <div class="thumbnail">
						      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-liveband'});return false;" data-value="category-liveband">
						...
						<div class="col-md-2 col-sm-3 col-xs-6">
						    <div class="thumbnail">
						      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-singer'});return false;" data-value="category-singer">
						...
						<div class="col-md-2 col-sm-3 col-xs-6">
						    <div class="thumbnail">
						      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-celebrity'});return false;" data-value="category-celebrity">
						...
						<div class="col-md-2 col-sm-3 col-xs-6">
						    <div class="thumbnail">
						      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-comedian'});return false;" data-value="category-comedian">
						...
						<div class="col-md-2 col-sm-3 col-xs-6">
						    <div class="thumbnail">
						      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-anchor'});return false;" data-value="category-anchor">
						...
						<div class="col-md-2 col-sm-3 col-xs-6 align-middle">
							<p>More Categories</p>
						...
						<div id="collapse-category" class="collapse">
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-dj'});return false;" data-value="category-dj">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-dancer'});return false;" data-value="category-dancer">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-insturmentalist'});return false;" data-value="category-insturmentalist">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-magician'});return false;" data-value="category-magician">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-makeupartist'});return false;" data-value="category-makeupartist">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-model'});return false;" data-value="category-model">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-photographer'});return false;" data-value="category-photographer">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-speaker'});return false;" data-value="category-speaker">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-1', 'event_label': 'category-varietyartist'});return false;" data-value="category-varietyartist">
 ...
 -->
					<div class="row">
						...
						<div class="col-md-2 col-sm-3 col-xs-6">
						    <div class="thumbnail">
						      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-2', 'event_label': 'event-privateparty'});return false;" data-value="event-privateparty">
						...
						<div class="col-md-2 col-sm-3 col-xs-6">
						    <div class="thumbnail">
						      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-2', 'event_label': 'event-inauguration'});return false;" data-value="event-inauguration">
						...
						<div class="col-md-2 col-sm-3 col-xs-6">
						    <div class="thumbnail">
						      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-2', 'event_label': 'event-corporate'});return false;" data-value="event-corporate">
						...
						<div class="col-md-2 col-sm-3 col-xs-6">
						    <div class="thumbnail">
						      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-2', 'event_label': 'event-campus'});return false;" data-value="event-campus">
						...
						<div id="collapse-event" class="collapse">
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-2', 'event_label': 'event-charity'});return false;" data-value="event-charity">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-2', 'event_label': 'event-concert'});return false;" data-value="event-concert">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-2', 'event_label': 'event-exhibition'});return false;" data-value="event-exhibition">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-2', 'event_label': 'event-fashionshow'});return false;" data-value="event-fashionshow">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-2', 'event_label': 'event-kidsparty'});return false;" data-value="event-kidsparty">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-2', 'event_label': 'event-photoshoot'});return false;" data-value="event-photoshoot">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-2', 'event_label': 'event-professionalhiring'});return false;" data-value="event-professionalhiring">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-2', 'event_label': 'event-religious'});return false;" data-value="event-religious">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
							    <div class="thumbnail">
							      <a href="" onclick="gtag('event', 'click', {'event_category': 'pyr-2', 'event_label': 'event-restaurant'});return false;" data-value="event-restaurant">
							        <img src="img/event-icon/restaurant.jpg" alt="" style="width:100%">
							        <div class="caption">
				...
				<fieldset id="fields-meta">
					<div class="row">
						<div class="col-md-12">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo input-meta" type="text" placeholder="Event Location" id="input-venue" name="eventvenue" data-dependency="input-date" data-validation="required" data-validation-error-msg="You did not enter a valid venue address" data-validation-error-msg-container="#venue-error-dialog" onclick="gtag('event', 'click', {'event_category': 'pyr-3', 'event_label': 'input-location'});"/>
					...
					<div class="row">
						<div class="col-md-6 col-md-offset-3">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo input-meta" type="text" placeholder="Event Date" id="input-date" name="datepicker" onclick="gtag('event', 'click', {'event_category': 'pyr-3', 'event_label': 'input-date'});"/>
						...
						<div class="col-md-6 col-md-offset-3">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo input-meta" type="number" id="input-budget" placeholder="Approx Budget" data-validation="required" data-validation-error-msg="You did not enter your budget" data-validation-error-msg-container="#budget-error-dialog" onclick="gtag('event', 'click', {'event_category': 'pyr-3', 'event_label': 'input-budget'});"/>
					...
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 col-xs-12" style="padding-top: 30px;">
							...
							<input id="button-continue-meta" type="submit" class="y-button" value="Continue" onclick="gtag('event', 'click', {'event_category': 'pyr-3', 'event_label': 'continue'});">
						</div>
					</div>
				</fieldset>
				...
				<fieldset id="fields-user">
					<div class="row">
						<div class="col-md-6 col-md-offset-3">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo input-user" type="text" id="input-name" placeholder="Full Name" data-validation="required" data-validation-error-msg="You did not enter a valid name" data-validation-error-msg-container="#name-error-dialog" onclick="gtag('event', 'click', {'event_category': 'pyr-4', 'event_label': 'input-name'});"/>
						...
						<div class="col-md-6 col-md-offset-3">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo input-user" type="email" id="input-email" placeholder="Email" data-validation="email" data-validation-error-msg="You did not enter a valid e-mail" data-validation-error-msg-container="#email-error-dialog" onclick="gtag('event', 'click', {'event_category': 'pyr-4', 'event_label': 'input-email'});"/>
						...
						<div class="col-md-6 col-md-offset-3">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo input-user" type="number" id="input-phone" placeholder="Phone Number" data-validation="length" data-validation-length="min10" data-validation-error-msg="You did not enter a valid 10 digit number" data-validation-error-msg-container="#phone-error-dialog" onclick="gtag('event', 'click', {'event_category': 'pyr-4', 'event_label': 'input-phone'});"/>
						...
						<div class="col-md-6 col-lg-offset-3 col-md-offset-3">
							<span class="input input--hideo">
								<textarea class="input__field input__field--hideo" type="text" id="input-info" placeholder="Additional Info"  cols="40" rows="2" style="resize: none;" onclick="gtag('event', 'click', {'event_category': 'pyr-4', 'event_label': 'input-additional'});"></textarea>
								<label class="input__label input__label--hideo" for="input-info">
									<i class="fa fa-fw fa-info icon icon--hideo"></i>
									<span class="input__label-content input__label-content--hideo">Additional details you want us to know</span>
								</label>
							</span>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 col-sx-12" style="padding-top: 30px;">
							<button id="button-submit" class="progress-button" data-style="rotate-side-down" onclick="gtag('event', 'click', {'event_category': 'pyr-5', 'event_label': 'get-quote'});" data-perspective data-horizontal>Get Quote</button>
						</div>
					</div>
				</fieldset>
                    ...
                    <div class="footer-logo-wrap">
                        <div class="footer-text-outer">
                            <div class="footer-text clearfix">
                                <div class="one">Made with <span style="color:#ff0000">❤</span> from all over the world</div>
                                <br/><br/>
                            </div>
                        </div>
                    </div>
		...
		<script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyBGauyAD765wmqPpYsSo5EBKRREdrSZcDQ"></script>
		...
		<script>
			$('#input-date').pickadate({
	            ...
	            onClose: function () {
	            	...
	            	$('#input-gathering').focus();
	                // if ($('#input-location').val().length != 0 && $('#input-date').val().length != 0) {
	                //     // $('#nextwherewhen').removeAttr('disabled').css('background', '#ee0979');
	                // }
	                // else {
	                //     // $('#nextwherewhen').attr('disabled', true).css('background', '#fb9ecb');
	                // }
	            }
	        });
